...
- [x] PostgreSQL 데이터 소스 연결 - `setup_metabase.py` 자동화
- [x] 초기 사용자 설정 - `setup_metabase.py` 자동화
...
### 1.4 Dashboard 레이아웃
- [x] 4개 패널 배치 (테이블/등급/녹화/헬스) - `setup_metabase.py` 자동화
- [x] Auto-refresh 설정 (5초) - `setup_metabase.py` 자동화
- [x] 모바일 반응형 확인 - Metabase 기본 지원 (README 문서화)
...
### 2.3 알림 시스템
- [x] 장애 발생 알림 (Primary/Secondary 연결 끊김) - `AlertManager.alert_connection_lost/restored()`
- [x] A등급 핸드 알림 - `AlertManager.alert_grade_a_hand()`
...
| `src/dashboard/alerts.py` | Alert, AlertManager 알림 시스템 |
| `tests/test_alerts.py` | 알림 시스템 테스트 (21개) |
| `deploy/metabase/dashboard-queries.sql` | Metabase SQL 쿼리 |
| `deploy/metabase/migrations/001_monitoring_tables.sql` | DB 마이그레이션 |
| `deploy/metabase/setup_metabase.py` | Metabase 자동 설정 스크립트 |
| `deploy/metabase/README.md` | Metabase 설정 가이드 |
...
| 2026-01-07 | Phase 2.3 알림 시스템 완료 (71%) - AlertManager 추가 | Claude |
| 2026-01-07 | Phase 1 미완료 항목 완료 (92%) - Metabase 자동화 | Claude |
