...
| PRD | 제목 | 설명 |
|-----|------|------|
| [PRD-0002](./PRD-0002-primary-gfx-rfid.md) | Primary Layer - GFX RFID | PokerGFX JSON API 기술 상세 |
| [PRD-0003](./PRD-0003-secondary-gemini-live.md) | Secondary Layer - Gemini Live | AI 비디오 분석 기술 상세 |
| [PRD-0004](./PRD-0004-fusion-engine.md) | Fusion Engine | 2중 검증 로직 기술 상세 |
...
> **기술 상세**: [PRD-0002: Primary Layer - GFX RFID](./PRD-0002-primary-gfx-rfid.md)
...
> **기술 상세**: [PRD-0004: Fusion Engine](./PRD-0004-fusion-engine.md)
...
> 상세: [PRD-0002: 플레이어 성향 분석](./PRD-0002-primary-gfx-rfid.md#7-플레이어-성향-분석)
...
> 상세: [PRD-0005: Metabase 대시보드](./PRD-0005-integrated-db-subtitle-system.md#b-metabase-시각화-대시보드)
